...
class HallwayDayNightView(arcade.View):
    ...
    def setup(self):
        ...
        try:
            ...
            print("-> Map HallwayDayNight load thành công!")
        ...
        arcade.set_background_color(self.tile_map.background_color or arcade.color.ORANGE_PEEL)
    ...
    def on_draw(self):
        ...
        if self.soldier.center_x >= (self.map_width_pixels - 50):
            arcade.draw_text("ENTER -> ĐÊM TỐI", self.view_left + 300, 300, arcade.color.WHITE, 20, bold=True)
