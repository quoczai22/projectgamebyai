...
class DayView(arcade.View):
    ...
    def setup(self):
        ...
        try:
            ...
            print("-> Map Day load thành công!")
        except FileNotFoundError:
            print(f"!!! Lỗi không tìm thấy map: {map_path}")
            return

        # 2. Soldier xuất hiện trong map
        ...
        # 3. OrcBot xuất hiện ngoài màn hình bên phải
        self.orc_bot = OrcBot()
    ...
    def on_draw(self):
        ...
        if self.soldier.center_x >= (self.map_width_pixels - 50):
            arcade.draw_text("ENTER -> TIẾP TỤC", self.view_left + 300, 300, arcade.color.WHITE, 20, bold=True)
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key in (arcade.key.LSHIFT, arcade.key.RSHIFT):
            ...
            limit_x = self.map_width_pixels - 50
