...
from final_level import FinalView
...
class CaveView(arcade.View):
    ...
    def setup(self):
        map_path = os.path.join(ASSETS_PATH, "maps", "examplecave.tmx")
    ...
    def on_draw(self):
        ...
        if self.view_left >= (self.map_width_pixels - SCREEN_WIDTH - 50):
            arcade.draw_text("ENTER -> TRUM CUOI", self.view_left + 300, 300, arcade.color.RED, 20, bold=True)
