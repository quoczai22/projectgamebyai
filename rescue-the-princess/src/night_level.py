...
from hallway_night_cave import HallwayNightCaveView
...
class NightView(arcade.View):
    ...
    def setup(self):
        map_path = os.path.join(ASSETS_PATH, "maps", "DayNitght.tmx")
        layer_options = {
        ...
        try:
            ...
            print("-> Map Night load thành công!")
        ...
        # OrcBot spawn ngoài màn hình bên phải
        self.orc_bot = OrcBot()
    ...
    def on_draw(self):
        ...
        if self.soldier.center_x >= (self.map_width_pixels - 50):
            arcade.draw_text("ENTER -> HÀNH LANG", self.view_left + 300, 300, arcade.color.WHITE, 20, bold=True)
    ...
    def switch_to_next_level(self):
        next_view = HallwayNightCaveView()
        next_view.setup()
